...
# + 1. Day sea ice advance previous year: common slope (1.3.2_D_common) --------------
...
var_full_name <- "Date of sea ice advance in the previous year"
...
# + 2.  Day sea ice advance previous year: distinct slopes (1.3.2_D_distinct) --------------
