...
# 1. Previous year ice-free days: common slope (1.1.2_E_common) ------------------------

# ~~~ a. Run the model ---------------------------------------------------------

{model_code <- "1.1.2_E"
model_code_to_call <- "1.1.2_D"
...
assign(x = paste0("fit_", model_code, "_", slope, mode),
       value = jags(data = dat, 
                    ...
                    n.thin = 10,
                    model.file = get(paste0("model_", model_code_to_call, "_", slope, "_slope", mode))))
...
# 2. Previous year ice-free days: distinct slopes (1.1.2_E_distinct) -----------
...
assign(x = paste0("fit_", model_code, "_", slope, mode),
       value = jags(data = dat, 
                    ...
                    n.iter = 30000, n.burnin = 5000, 
                    n.thin = 10,
                    model.file = get(paste0("model_", model_code_to_call <- "1.1.2_D", "_", slope, "_slope", mode))))
...
# 3. 2y prior ice-free days: common slope (1.1.3_E_common) -------------------------

# ~~~ a. Run the model ---------------------------------------------------------
{model_code <- "1.1.3_E"
model_code_to_call <- "1.1.3_D"
...
# 4. 2y prior ice-free days: distinct slopes (1.1.3_E_distinct) ====================
