#==============================================================================#
#                                                                              #
#                      Models with only June-November Ice                      #
#                                                                              #
#==============================================================================#

# mean daily percent of the continental shelf covered by sea ice of ≥15% concentration 
# summed from June to November (as in Rode et al. 2021)
...
sea_ice_data <- data.frame(sea_ice_data,
                           jun_nov_ice_previous = c(NA, sea_ice_data$jun_nov[-nrow(sea_ice_data)]),
                           jun_nov_ice_2y_prior = c(NA, NA, sea_ice_data$jun_nov[-c(nrow(sea_ice_data),
                                                                                    nrow(sea_ice_data) - 1)]))
...
source("05_script/models/1_sea_ice/1.5_Nimble_june_november_ice.R")
...
# B. June-November ice t-1 =========================================================

# ~ 1. Effect only on 1cub VS 0cubs (1.5.2_D_1c_VS_0c) -------------------------
...
# Predictor
var <- data_model$jun_nov_ice_previous
var_scaled <- (var - mean(var))/sd(var) 
var_short_name <- "jun_nov_ice_previous_s"
var_full_name <- "JuneNovemberIce in previous year"
...
# ~ 2. Effect only on 2-3cub VS 0cubs (1.5.2_D_2-3c_VS_0c) ---------------------
...
# ~ 3. Common effect of 1c VS 0 and of 2-3c VS 0 (1.5.2_D_common) --------------
...
# ~ 4. Distinct effect of 1c VS 0 and of 2-3c VS 0 (1.5.2_D_distinct) --------------
...
# C. June-November ice t-2 =========================================================

# ~ 1. Effect only on 1cub VS 0cubs (1.5.3_D_1c_VS_0c) -------------------------
...
# Predictor
var <- data_model$jun_nov_ice_2y_prior
var_scaled <- (var - mean(var))/sd(var) 
var_short_name <- "jun_nov_ice_2y_prior_s"
var_full_name <- "JuneNovemberIce two years before"
...
# ~ 2. Effect only on 2-3cub VS 0cubs (1.5.3_D_2-3c_VS_0c) ---------------------
...
# ~ 3. Common effect of 1c VS 0 and of 2-3c VS 0 (1.5.3_D_common) --------------
...
# ~ 4. Distinct effect of 1c VS 0 and of 2-3c VS 0 (1.5.3_D_distinct) ----------
