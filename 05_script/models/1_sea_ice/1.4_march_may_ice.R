...
sea_ice_data <- data.frame(sea_ice_data,
                           mar_may_ice_previous = c(NA, sea_ice_data$mar_may[-nrow(sea_ice_data)]),
                           mar_may_ice_2y_prior = c(NA, NA, sea_ice_data$mar_may[-c(nrow(sea_ice_data),
                                                                                    nrow(sea_ice_data) - 1)]))
...
source("05_script/models/1_sea_ice/1.4_Nimble_march_may_ice.R")
...
# ~ 1. Effect only on 1cub VS 0cubs (1.4.2_D_1c_VS_0c) -------------------------
...
# Predictor
var <- data_model$mar_may_ice_previous
var_scaled <- (var - mean(var))/sd(var) 
var_short_name <- "mar_may_ice_previous_s"
var_full_name <- "MarchMayIce in previous year"
...
# ~ 2. Effect only on 2-3cub VS 0cubs (1.4.2_D_2-3c_VS_0c) ---------------------
...
# ~ 3. Common effect of 1c VS 0 and of 2-3c VS 0 (1.4.2_D_common) --------------
...
# ~ 4. Distinct effect of 1c VS 0 and of 2-3c VS 0 (1.4.2_D_distinct) --------------
...
# ~ 1. Effect only on 1cub VS 0cubs (1.4.3_D_1c_VS_0c) -------------------------
...
# Predictor
var <- data_model$mar_may_ice_2y_prior
var_scaled <- (var - mean(var))/sd(var) 
var_short_name <- "mar_may_ice_2y_prior_s"
var_full_name <- "MarchMayIce two years before"
...
# ~ 2. Effect only on 2-3cub VS 0cubs (1.4.3_D_2-3c_VS_0c) ---------------------
...
# ~ 3. Common effect of 1c VS 0 and of 2-3c VS 0 (1.4.3_D_common) --------------
...
# ~ 4. Distinct effect of 1c VS 0 and of 2-3c VS 0 (1.4.3_D_distinct) ----------
