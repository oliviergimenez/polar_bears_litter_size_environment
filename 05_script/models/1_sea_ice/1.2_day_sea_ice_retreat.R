...
# + 1. Day sea ice retreat previous year: common slope (1.2.2_D_common) --------------
...
var_full_name <- "Date of sea ice retreat in the previous year"
...
# + 2.  Day sea ice retreat previous year: distinct slopes (1.2.2_D_distinct) --------------
