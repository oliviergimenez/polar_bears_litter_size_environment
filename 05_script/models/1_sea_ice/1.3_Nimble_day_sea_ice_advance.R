...
# A. Day advance t-1 ===========================================================
# ~ 1. Ice-free days t-1: effect 1c_VS_0c (1.3.2_D) ============================

model_1.3.2_D_effect_1c_VS_0c <- nimbleCode({
...
# ~ 2. Ice-free days t-1: effect 2-3c_VS_0c (1.3.2_D) =============================

model_1.3.2_D_effect_2_3c_VS_0c <- nimbleCode({
...
# ~ 3. Ice-free days t-1: effect common (1.3.2_D) =============================

model_1.3.2_D_effect_common <- nimbleCode({
...
# B. Day advance t-2 ==========================================================
# ~ 1. Ice-free days t-2: effect 1c_VS_0c (1.3.3_D) ==============================

model_1.3.3_D_effect_1c_VS_0c <- nimbleCode({
...
# ~ 2. Ice-free days t-2: effect 2-3c_VS_0c (1.3.3_D) =============================

model_1.3.3_D_effect_2_3c_VS_0c <- nimbleCode({
...
# ~ 3. Ice-free days t-2: effect common (1.3.3_D) =============================

model_1.3.3_D_effect_common <- nimbleCode({
