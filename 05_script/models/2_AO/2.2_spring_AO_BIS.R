...
source("05_script/models/2_AO/2.2_JAGS_spring_AO.R")
...
# 1. Spring AO: common slope (2.2.1.1_common_bis) -----------------------------
...
# 2. Spring AO: distinct slopes (2.2.1.1_distinct_bis) ------------------------
...
# 3. Previous spring AO: common slope (2.2.2.1_common_bis) ------------------------
...
var_full_name <- "Previous spring AO index"
...
# 4. Previous spring AO: distinct slopes (2.2.2.1_distinct_bis) -------------------
...
# 5. 2y prior spring AO: common slope (2.2.3.1_common_bis) -------------------------
...
var_full_name <- "2 year prior spring AO index"
...
# 6. 2y prior spring AO: distinct slopes (2.2.3.1_distinct_bis) ====================
...
# 7. spring AO : distinct slopes, FACTOR (2.2.1.2_distinct_bis) --------------------
...
# 8. Previous spring AO : distinct slopes, FACTOR (2.2.2.2_distinct_bis) ----------
...
var_full_name <- "Previous spring AO phase"
...
# 9. 2y prior spring AO : distinct slopes, FACTOR (2.2.3.2_distinct_bis) -------
...
var_full_name <- "2 year prior spring AO phase"
