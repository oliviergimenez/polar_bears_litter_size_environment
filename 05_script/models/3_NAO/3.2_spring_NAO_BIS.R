...
source("05_script/models/3_NAO/3.2_JAGS_spring_NAO.R")
...
# 1. Spring NAO: common slope (3.2.1.1_common_bis) -----------------------------
...
var_full_name <- "Spring NAO index"
...
# 2. Spring NAO: distinct slopes (3.2.1.1_distinct_bis) ------------------------
...
# 3. Previous spring NAO: common slope (3.2.2.1_common_bis) ------------------------
...
var_full_name <- "Previous spring NAO index"
...
# 4. Previous spring NAO: distinct slopes (3.2.2.1_distinct_bis) -------------------
...
# 5. 2y prior spring NAO: common slope (3.2.3.1_common_bis) -------------------------
...
var_full_name <- "2 year prior spring NAO index"
...
# 6. 2y prior spring NAO: distinct slopes (3.2.3.1_distinct_bis) ====================
...
# 7. spring NAO : distinct slopes, FACTOR (3.2.1.2_distinct_bis) --------------------
...
var_full_name <- "Spring NAO phase"
...
df.plot <- get(paste0("fit_", model_code, "_", slope, mode, "_for_plot"))
...
# 8. Previous spring NAO : distinct slopes, FACTOR (3.2.2.2_distinct_bis) ----------
...
var_full_name <- "Previous spring NAO phase"
...
# 9. 2y prior spring NAO : distinct slopes, FACTOR (3.2.2.2_distinct_bis) ------
...
var_full_name <- "2 year prior spring NAO phase"
